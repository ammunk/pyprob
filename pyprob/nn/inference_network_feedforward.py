            ...
            for variable in example_trace.variables_controlled:
                ...
                if address not in self._layers_proposal:
                    ...
                    if isinstance(distribution, Normal):
                        layer = ProposalNormalNormalMixture(self._observe_embedding_dim+self._sample_attention_embedding_dim, variable_shape, mixture_components=self._proposal_mixture_components)
                    elif isinstance(distribution, Uniform):
                        layer = ProposalUniformTruncatedNormalMixture(self._observe_embedding_dim+self._sample_attention_embedding_dim, variable_shape, mixture_components=self._proposal_mixture_components)
                    elif isinstance(distribution, Poisson):
                        layer = ProposalPoissonTruncatedNormalMixture(self._observe_embedding_dim+self._sample_attention_embedding_dim, variable_shape, mixture_components=self._proposal_mixture_components)
